...
//            $(this).css({color: '#3D3D3DC'})
    ...
    window.basket = {
        ...
        updateForm: function(){
            ...
            if(window.tobiz.basket_conf!==null){
            ...
            if(typeof(bc.basket_free_delivery)!=='undefined'){
                if(this.countSum()>bc.basket_free_delivery_from){
                    ...
                    ');
                    $('#basket_make_order input[name="delivery"]').val('Платная доставка');     
        ...
        renderForm: function () {
            ...
            if(window.tobiz.basket_conf!==null && typeof(window.tobiz.basket_conf.basket_extra) !=='undefined'){
